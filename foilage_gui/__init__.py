...
Tabs:
    ...
    Optimization multi-objective (NSGA-II or Adaptive Hybrid Search)
                 optimization of results.json quantities over pyturbo geometry
                 ranges, live Pareto/fitness plots, all cases recorded
